        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="type" name="type">
 			...
 			<div class="form-group">
  			...
  			<button type="submit" class="btn btn-outline-secoundry">Submit</button>
  			<button type="reset" class="btn btn-outline-secoundry">Cancel</button>
        <button type="submit" class="btn btn-outline-secoundry">Edit</button>
		</form>
